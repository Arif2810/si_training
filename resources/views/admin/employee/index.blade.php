              ...
              <table id="example1" class="table table-bordered table-hover">
                ...
                <tbody>
                  ...
                  <tr>
                    ...
                    <td>
                      <a href="employee/{{$employees->id_karyawan}}/show"><button class="btn btn-primary btn-xs">Detail</button></a>
											@if(Auth::user()->akses == 'admin')
                      <a href="employee/{{$employees->id_karyawan}}/edit"><button class="btn btn-warning btn-xs">Edit</button></a>
                      <button class="btn btn-danger btn-xs" data-delid={{$employees->id_karyawan}} data-toggle="modal" data-target="#delete"><i class="glyphicon glyphicon-trash"></i> Hapus</button>
											@endif
                    </td>
                  </tr>
                  @endforeach
