            ...
            <div class="col-xs-12">
                <div class="box" style="padding: 0 30px">
                  <div class="box-header">
                    <div class="box-header">
                      <h5 class="box-title">Tambah data rute</h5>
                    </div>
                    <div class="box-body">
                      ...
                      <form action="{{ url('/route') }}" method="post">
                        <div>
                          <label>Rute</label>
                          {!!Form::text('nama_rute', null, ['class'=>'form-control'])!!}
                        </div><br><br>
                        <div>
      ...
      <div class="row">
        <div class="col-xs-12">
          <div class="box" style="padding: 0 30px">
            <div class="box-header">
              <div class="box-header">
                <h3 class="box-title">Data rute karyawan</h3>
              </div>
              <!-- /.box-header -->
              <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $no++ }}</td>
                      <td>{{ $routes->nama_rute }}</td>
                      <td>
                        <a href="{{ url('route') }}/{{$routes->id_rute}}/edit"><button class="btn btn-warning btn-xs">Edit</button></a>
                        <button class="btn btn-danger btn-xs" data-delid={{$routes->id_rute}} data-toggle="modal" data-target="#delete"><i class="glyphicon glyphicon-trash"></i> Hapus</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
