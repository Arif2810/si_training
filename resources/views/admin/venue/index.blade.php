            ...
            <div class="col-xs-12">
                <div class="box" style="padding: 0 30px">
                  <div class="box-header">
                    <div class="box-header">
                      <h5 class="box-title">Tambah data venue</h5>
                    </div>
                    <div class="box-body">
                      ...
                      <form action="{{ url('/venue') }}" method="post">
                        <div>
                          ...
                          {!!Form::text('nama_venue', null, ['class'=>'form-control'])!!}
                        </div><br><br>
                        <div>
              ...
              <div class="box-body">
                ...
                <table id="example1" class="table table-bordered table-hover">
                  ...
                  <tbody>
                    ...
                    <tr>
                      <td>{{ $no++ }}</td>
                      <td>{{ $venues->nama_venue }}</td>
                      <td>
                        <a href="venue/{{$venues->id_venue}}/edit"><button class="btn btn-warning btn-xs">Edit</button></a>
                        <button class="btn btn-danger btn-xs" data-delid={{$venues->id_venue}} data-toggle="modal" data-target="#delete"><i class="glyphicon glyphicon-trash"></i> Hapus</button>
                      </td>
                    </tr>
                    @endforeach
                  </tbody>
